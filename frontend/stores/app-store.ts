...
import User from 'Frontend/generated/org/communique/data/entity/User';
import Role from 'Frontend/generated/org/communique/data/Role';
import { makeAutoObservable } from 'mobx';

export class AppStore {
  applicationName = 'Communique';
