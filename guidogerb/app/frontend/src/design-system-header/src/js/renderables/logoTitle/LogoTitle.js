...
export function LogoTitle() {
  ...
  const logoTitleURL = (
    HeaderSettings.titleUrl
    // @ts-expect-error backwards compatibility
    || /** @type {string | undefined} */ (HeaderSettings.titleURL)
  );
  ...
  const settingsLogo = HeaderSettings.logo;
  const settingsShowTitle = HeaderSettings.showTitle;
  const settingsTitle = HeaderSettings.title;
  if (settingsLogo) {
