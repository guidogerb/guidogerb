 ...
 * Interact with `settings` using getHeaderSettings() and setHeaderSettings().
 ...
 * to setHeaderSettings. So make sure out all the required fields in this object with sensible
