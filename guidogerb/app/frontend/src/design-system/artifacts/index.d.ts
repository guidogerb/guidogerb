declare module "design-system" {
  export namespace popupPlacement {
    let AUTO: import("design-system-header").PopupPlacement;
    let AUTO_START: import("design-system-header").PopupPlacement;
    let AUTO_END: import("design-system-header").PopupPlacement;
    let BOTTOM: import("design-system-header").PopupPlacement;
    let BOTTOM_START: import("design-system-header").PopupPlacement;
    let BOTTOM_END: import("design-system-header").PopupPlacement;
    let LEFT: import("design-system-header").PopupPlacement;
    let LEFT_START: import("design-system-header").PopupPlacement;
    let LEFT_END: import("design-system-header").PopupPlacement;
    let RIGHT: import("design-system-header").PopupPlacement;
    let RIGHT_START: import("design-system-header").PopupPlacement;
    let RIGHT_END: import("design-system-header").PopupPlacement;
    let TOP: import("design-system-header").PopupPlacement;
    let TOP_START: import("design-system-header").PopupPlacement;
    let TOP_END: import("design-system-header").PopupPlacement;
  }
  ...
  export function Tooltip({ children, className, innerRef: draftInnerRef, isPopperVisible, offset, placement, referenceElement: draftReferenceElement, }: {
    ...
    placement?: import("design-system-header").PopupPlacement | undefined;
  ...
  export const DesignSystemContext: React.Context<ImmerHookDesignSystemContext>;
  export function useDesignSystemContext(): ImmerHookDesignSystemContext;
  export type ImmerHookDesignSystemContext = import("use-immer").ImmerHook<DesignSystemContextValue>;
  ...
  export function useBanner(): {
    addBanner: (arg0: DesignSystemContextBanner) => void;
    removeBanner: (arg0: DesignSystemContextBanner) => void;
  };
  export function BannersGlobal({ banners, bannerDuration }: {
    banners: DesignSystemContextBannerWithId[];
  ...
  export const HeaderContext: React.Context<{
    settings: import("design-system-header").Settings;
    setSettings: import("use-immer").Updater<import("design-system-header").Settings>;
    settingsRef: React.RefObject<import("design-system-header").Settings>;
  }>;
  ...
  export function HeaderContextProvider({ children, defaultSettings }: {
    children: React.ReactNode;
    defaultSettings?: Partial<import("design-system-header").Settings> | undefined;
  }): React.JSX.Element;
  ...
  export type ChildrenMenuTypes = import("design-system-header").ChildrenMenuTypes;
  export type MenuItemFunctionUrlAction = import("design-system-header").MenuItemFunctionUrlAction;
  export type MenuItemUrlAction = import("design-system-header").MenuItemUrlAction;
  ...
  export type DesignSystemContextBannerWithId = {
    className?: string | undefined;
  ...
  export type DesignSystemContextBanner = {
    className?: string | undefined;
    duration?: number | undefined;
    id?: string | undefined;
    icon?: React.ReactNode;
  ...
  export type DesignSystemContextAria = {
    assertiveMessages: string[];
    politeMessages: string[];
  };
  export type DesignSystemContextValue = {
    ariaLive: DesignSystemContextAria;
    banners: DesignSystemContextBannerWithId[];
  };
  export type VerticalMenuMenuItemAdditions = {
    actionUrl?: import("design-system-header").MenuItemUrlAction | undefined;
    actionFunction?: EventAction | undefined;
    actionFunctionUrl?: import("design-system-header").MenuItemFunctionUrlAction | undefined;
  };
  export type WebsiteMainMenuItem = {
    ...
    childrenMenuType?: import("design-system-header").ChildrenMenuTypes | null | undefined;
    isSelected?: boolean | undefined;
