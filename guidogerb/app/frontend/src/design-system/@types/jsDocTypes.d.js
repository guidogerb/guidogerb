...
/** @typedef {import ('design-system-header').ChildrenMenuTypes} ChildrenMenuTypes */
/** @typedef {import('design-system-header').MenuItemFunctionUrlAction} MenuItemFunctionUrlAction */
/** @typedef {import('design-system-header').MenuItemUrlAction} MenuItemUrlAction */
...
/**
 * @typedef DesignSystemContextBannerWithId {
...
/**
 * @typedef DesignSystemContextBanner {
 *  @property {string} [className]
 *  @property {number} [duration]
 *  @property {string} [id]
 *  @property {import('react').ReactNode} [icon]
...
/**
 * @typedef DesignSystemContextAria {
...
/**
 * @typedef DesignSystemContextValue {
 *  @property {DesignSystemContextAria} ariaLive
 *  @property {DesignSystemContextBannerWithId[]} banners
 * }
 */
