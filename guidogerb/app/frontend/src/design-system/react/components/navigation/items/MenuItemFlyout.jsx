import { popupFocusHandler } from 'design-system-header';
...
/** @typedef {import('design-system').MenuTypes} MenuTypes  */
          ...
          ((!menuItem?.link && !menuItem.actionFunction && !menuItem.actionFunctionUrl && !menuItem.actionUrl) || menuItem?.link?.includes('::'))
            ? (
              ...
              >
                ...
                {menuItem.children ? <span className="ds-icon-before-chevron-right vertical-menu__chevron is-closed" aria-hidden="true" /> : null}
              </button>
            )
            : (
              <MenuItemNavLink
          ...
          (menuItem.children && menuItem.link)
            ? (
              <IconButton
                ...
                icon={<span className="ds-icon-before-chevron-right icon" aria-hidden="true" />}
