...
/** @typedef {import('design-system').EventAction} EventAction */
/**
 * @template MutableRefT
 * @typedef {import('design-system').MutableRef<MutableRefT>} MutableRef
 */
          ...
          <IconButton
            ...
            icon={
              ...
              ?? (
                <span
                  aria-hidden="true"
                  className={isOptionsExpanded ? 'ds-icon-before-chevron-up' : 'ds-icon-before-chevron-down'}
                />
              )
            }
            isDisabled={isDisabled}
