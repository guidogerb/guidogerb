 ...
 * @typedef {import('design-system').TableSortingRuleType<TableSortingRuleT>} TableSortingRuleType
 */
/**
 * @template TableContextStateT
 * @typedef {import('design-system').TableContextState<TableContextStateT>} TableContextState
 */
/**
 * @template TableContextStateT
 * @typedef {import('design-system').TableContextValue<TableContextStateT>} TableContextValue
 */
...
export function TableWrapper({
  ...
  /** @type {[TableContextState<TableDataT>, import('use-immer').Updater<import('design-system').TableContextState<TableDataT>>]} */
