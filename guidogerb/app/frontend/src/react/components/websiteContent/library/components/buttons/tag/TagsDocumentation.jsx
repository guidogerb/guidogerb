    ...
    <div className="documentation-content">
      ...
      <StaticExample
        ...
        renderedExample={(
          <div className="flex flex-col full-width items-center">
            <div className="flex gap-s mb-spacing">
              <Tag iconLeft={<span className="ds-icon-before-arrow-left" aria-hidden="true" />} className="tag--selected">Left</Tag>
              <Tag iconRight={<span className="ds-icon-before-arrow-right" aria-hidden="true" />}>Right</Tag>
            </div>
            <div className="flex gap-s">
