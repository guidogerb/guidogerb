...
import { Popup, popupPlacement, Tab, TabGroup, TabList, TabPanel, TabPanels, VerticalMenu } from 'design-system';
import { childrenMenuTypes } from 'design-system-header';
  ...
  return (
    <div className="documentation-content">
      ...
      <StaticExample
        ...
        renderedExample={<LightBox image="" alt="Vertical Menu Sidebar" className="flex-3up-gap" />}
        quickTips={(
          <ul>
      ...
      <StaticExample
        ...
        renderedExample={<LightBox image="" alt="Vertical Menu - On this page" className="flex-3up-gap" />}
        quickTips={(
          <ul>
              ...
              <VerticalMenu menus={[
                {
                  ...
                  menuItems: [
                    ...
                    },
                    {
                      ...
                      childrenMenuType: childrenMenuTypes.FLYOUT,
                      link: 'https://guidogerbpublishing.com',
                    },
                    {
                      id: 'menu-in-popup-C',
