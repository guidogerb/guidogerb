...
import { Tab, TabGroup, TabList, TabPanel, TabPanels } from 'design-system';
        ...
        renderedExample={(
          <div className="flex gap">
            ...
            <div
              ...
              style={{ width: '33%' }}
            >
              <span className="ds-icon-before-gear card__icon" aria-hidden="true" />
            ...
            <div class="flex justify-end">
              ...
              >
                ...
                <span class="button--icon button--icon-right">
                  <span
                    class="ds-icon-before-arrow-right"
                    aria-hidden="true"
                  ></span>
                </span>
              </button>
