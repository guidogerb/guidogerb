  ...
  return (
    <div className="documentation-content">
        ...
        renderedExample={(
          <div className="flex-col pt-spacing">
            <Switch
              label="With Icon"
              id="switch-icon"
              sliderChildren={<span className="ds-icon-before-check" aria-hidden="true" />}
            />
          </div>
        )}
        quickTips={(
      ...
      <ul className="mb-spacing">
        ...
        <li>
          The switch provided by the Design System is a restyled <Link to={pageUrls.checkbox}>checkbox</Link>. Where possible,
