    ...
    <div className="documentation-content">
      ...
      <ul className="mb-spacing">
        <li><strong>Main Menu</strong>
          <ul>
            <li><strong>Always use</strong>. The Main Menu and Search bar is used in conjunction with the Header to instill a sense of trust that this is a state of site.</li>
      ...
      <ul className="mb-spacing">
        <li><strong>Always use the Main Menu in conjunction with the Header</strong>. The Header and the Main Menu and Search bar will be used together across all state websites and applications.</li>
      </ul>
      ...
      <h2 id="header-configuration-settings" className="my-spacing">Header Configuration Settings</h2>
      <p>The following settings are used to configure the main menu with the <NavLink to={pageUrls.Header}>Header</NavLink>.</p>
