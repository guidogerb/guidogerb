        ...
        renderedExample={(
          <>
            <Button
              appearance="outlined"
              color="primary"
              iconLeft={<span className="ds-icon-before-check" aria-hidden="true" />}
            ...
            <Button
              appearance="solid"
              color="primary"
              iconRight={<span className="ds-icon-before-arrow-right" aria-hidden="true" />}
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              For example <code>Read More <span className="ds-icon-before-arrow-right icon" aria-hidden="true" /></code>.
            </li>
            <li>Use the button style for a call to action. For example, <code>Register Now <span className="ds-icon-before-arrow-right icon" aria-hidden="true" /></code>.</li>
          </ul>
        </li>
      </ul>
