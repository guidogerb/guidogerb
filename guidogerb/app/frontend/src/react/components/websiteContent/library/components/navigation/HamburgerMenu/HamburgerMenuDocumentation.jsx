    ...
    <div className="documentation-content">
      ...
      <StaticExample
        ...
        renderedExample={(
          <IconButton
            ...
            icon={<span className={isOpen ? 'ds-icon-before-x-icon' : 'ds-icon-before-hamburger'} aria-hidden="true" />}
      ...
      <ul className="mb-spacing">
        ...
        <li>
          ...
          ( <span className="ds-icon-before-hamburger" aria-hidden="true" />) represents a collapsed menu, while an &quot;X&quot; ( <span className="ds-icon-before-x-icon" aria-hidden="true" />) represents an open menu.
        </li>
      </ul>
