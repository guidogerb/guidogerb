...
// https://www.abc4.com/news/digital-exclusives/attention-newns-seven-unique-foods-to-know/
const example3Menu = [
  {
    ...
    menuItems: [
      ...
      { title: 'Honey', id: 'example3-honey', link: 'example3-honey' },
    ],
  },
];
const example4Menu = [
    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Honey', id: 'example4-honey', link: 'example4-honey' },
        ],
        childrenMenuType: childrenMenuTypes.FLYOUT,
      },
    ],
