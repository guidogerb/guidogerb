import { Button, joinClassNames } from 'design-system';
...
/** @typedef {import('design-system-website').ColorInfo} ColorInfo */
  ...
  return (
    <div className="color-contrast__wrapper">
              ...
              >
                {
                  selectedColorTitles.includes(title)
                    ? <span className="ds-icon-before-check" aria-hidden="true" />
                    : ''
                }
              </Button>
            );
      ...
      <div className="color-contrast__info-link">
        <span className="ds-icon-before-help" aria-hidden="true" />
