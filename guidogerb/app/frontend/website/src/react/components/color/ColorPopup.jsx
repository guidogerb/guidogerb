      ...
      >
        <div className="color-picker-popup__title-bar" ref={draggableDivRef}>
          ...
          >
            <div>
              <span
                className={`ds-icon-before-circle-chevron-down icon-button__icon ${isOpen ? '' : 'icon-button__icon--rotate180'}`}
                aria-hidden="true"
              />
          ...
          <IconButton
            ...
            icon={(
              <div>
                <span
                  className="ds-icon-before-more-vertical"
                  aria-hidden="true"
                />
                <span className="visually-hidden">
                  more vertical
          ...
          >
            ...
            >
              <span className="ds-icon-before-restart mr-spacing-xs" aria-hidden="true" /> Reset color picker
            </Button>
            <Button
            ...
            >
              <span className="ds-icon-before-share mr-spacing-xs" aria-hidden="true" /> {copiedUrlTitle}
            </Button>
            <Button
              className="full-width mt-spacing-s"
              onClick={() => {
            ...
            >
              <span className="ds-icon-before-share mr-spacing-xs" aria-hidden="true" /> {copiedCSSTitle}
            </Button>
          </Popup>
          {
            showRandomizingIcon
              ? (
                <div className="color-picker-popup__buttons">
                  <IconButton
                    icon={<span className="ds-icon-before-visibility" aria-hidden="true" />}
