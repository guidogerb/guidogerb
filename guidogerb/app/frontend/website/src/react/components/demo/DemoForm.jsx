import { BUTTON_APPEARANCE, Button, CharacterCount, Checkbox, DateInput, ExternalLink, Form, MultiSelect, MultiSelectOption, RadioButton, RadioButtonGroup, Switch, TextArea, TextInput, TimeInput, componentColors, useBanner } from 'design-system';
 ...
 * @param {(banner: DesignSystemContextBanner) => void} addBannerFn
  ...
  if (!fieldToValidate) {
    if (Object.values(errors).length) {
      addBannerFn({
        ...
        icon: <span className="ds-icon-before-warning" aria-hidden="true" />,
  ...
  return (
    <>
      ...
      <p className="text-center">
        <ExternalLink
          href="https://github.com/guidogerb/design-system/blob/main/design-system-website/src/react/components/demo/DemoForm.jsx"
        >
