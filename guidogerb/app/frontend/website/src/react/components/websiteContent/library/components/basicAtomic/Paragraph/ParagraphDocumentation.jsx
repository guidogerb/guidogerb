...
export function ParagraphDocumentation() {
  return (
    <div className="documentation-content">
      ...
      <p>See <Link to={pageUrls.Header}>Header</Link>, <Link to={pageUrls.Footer}>Footer</Link>, <Link to={pageUrls.mainMenu}>Main Menu</Link>, <Link to={pageUrls.verticalMenu}>Vertical Menu</Link>.</p>
