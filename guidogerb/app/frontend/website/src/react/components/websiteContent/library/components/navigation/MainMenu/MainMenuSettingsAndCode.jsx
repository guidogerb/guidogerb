...
export function MainMenuSettingsAndCode() {
  return (
    <>
      ...
      <p>
        The Header&apos;s Main Menu allows common site navigation across all state of content.
        Use the Header Main Menu configuration to create your site&apos;s navigation.
      </p>
