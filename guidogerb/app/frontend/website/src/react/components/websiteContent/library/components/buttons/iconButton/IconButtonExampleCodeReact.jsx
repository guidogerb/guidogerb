import { formElementSizesEnum } from 'design-system';
...
export function IconButtonExampleCodeReact({
  ...
  return (
    <>
      ...
      <ExampleCodeReactProp displayProp={`icon={<span className={\`ds-icon-before-${iconCssClass}\`} aria-hidden="true" />}`} indentLevel={1} />
