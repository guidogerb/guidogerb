import { Form, Select, SelectOption, Switch, TextInput } from 'design-system';
import { useFormState } from '../../../../../../hooks/useFormState';

/** @typedef {import('design-system-website').TabGroupExamplePropsShape} TabGroupExamplePropsShape */
