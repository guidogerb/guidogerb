  ...
  return (
    <div className="static-example mt-spacing-xl">
      <HeadingWithLink
        ...
        linkUrl="https://github.com/guidogerb/design-system/tree/main/design-system-website/src/react/components/websiteContent/library/components/table/exampleTables/TableDocumentationPaginationTableExample.jsx"
      />
