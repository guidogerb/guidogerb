...
/** @typedef {import('design-system-website').SwitchExamplePropsShape} SwitchExamplePropsShape */
  ...
  return (
    <Switch
      ...
      sliderChildren={
        ((icon === 'none') || !icon)
          ? null
          : <span className={icon === 'visibility' ? 'ds-icon-before-visibility' : 'ds-icon-before-check'} aria-hidden="true" />
      }
      value={value}
