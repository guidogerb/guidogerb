  ...
  return (
    <div className="documentation-content">
      ...
      <StaticExample
        ...
        renderedExample={(
          <div>
            ...
            <p>This is an example of what an external link or link that opens in a new tab should appear like within a block of text: <ExternalLink href="https://www.google.com/search?q=utah+state+flag">State Flag</ExternalLink></p>
            <p>This is an example of a phone number link: <a href="tel:18006783440"><span className="visually-hidden">help desk phone number:</span>800-678-3440</a></p>
            <p className="mb-auto">This is an example of a email address link: <a href="mailto:ui@guidogerbpublishing.gov"><span className="visually-hidden">Digital experience team email:</span>ui@guidogerbpublishing.gov</a></p>
          </div>
        )}
        quickTips={(
          <ul>
            ...
            <li>Links that navigate the user to an external resource should be clearly identified using the external link icon (<span className="ds-new-tab-link-a11y"><span className="visually-hidden">external link icon</span><span className="ds-icon-after-external-link" aria-hidden="true" /></span> ) or an icon that has a similar meaning. <a href="#external-link-example">See example below.</a></li>
      ...
      <StaticExample
        title="Image Links"
        renderedExample={(
          <a href="#section-examples"><img src="" alt="Trax in downtown Salt Lake City" width="250" /></a>
        )}
        quickTips={(
          <ul>
        ...
        <li>
          ...
          <PreCodeForCodeString
            ...
            codeRaw={`
              ...
              <a href="mailto:ui@guidogerbpublishing.gov">Email the Digital Experience Team</a>
            `}
          />
        </li>
      </ul>
      ...
      <ul className="mb-spacing">
        ...
        <li>
          ...
          For example: <a href="tel:18006783440"><span className="visually-hidden">help desk phone number:</span>800-678-3440</a>
        </li>
        <li>
          ...
          For example: <a href="mailto:ui@guidogerbpublishing.gov"><span className="visually-hidden">Digital experience team email:</span>ui@guidogerbpublishing.gov</a>
        </li>
      </ul>
    </div>
  );
