...
/** @typedef {import('design-system').DrawerPlacement} DrawerPlacement */
...
/** @typedef {import('design-system').IconButtonAppearance} IconButtonAppearance */
/** @typedef {import('design-system').WrapInElement} WrapInElement */
/** @typedef {import('design-system').skeletonTypes} skeletonTypes */
/** @typedef {import('design-system-header').ChildrenMenuTypes} ChildrenMenuTypes */

/** @typedef {import('design-system-header').PopupPlacement} PopupPlacement */
