 ...
 *
 * All our urls are found in design-system-website/src/react/components/routing/pageUrls.js
...
const ROOT_URL = 'https://designsystem';
...
const dir = 'design-system-website/public';
...
fs.writeFile(
  'design-system-website/public/sitemap.txt',
  content,
  (err) => {
    if (err) {
