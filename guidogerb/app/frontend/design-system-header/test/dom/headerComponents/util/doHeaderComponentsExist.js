...
export function expectHeaderComponentsExistSanityCheck() {
  ...
  expect(domConstants.UTAH_DESIGN_SYSTEM).toBe('design-system');
  expect(domConstants.HEADER).toBe('ds-header');
  expect(domConstants.FOOTER).toBe('ds-footer');
  ...
  expect(domConstants.ACTION_ITEM).toBe('ds-header-action-item');
  expect(domConstants.ACTION_ITEM__ICON_BUTTON).toBe('ds-header-action-item__icon-button');
  expect(domConstants.ACTION_ITEM__ICON_BUTTON_TITLE).toBe('ds-header-action-item__icon-button--has-title');
  expect(domConstants.ACTION_ITEM__TITLE).toBe('ds-header-action-item__title');
  expect(domConstants.ACTION_ITEMS__WRAPPER).toBe('ds-action-items-wrapper');
  expect(domConstants.BADGE__LABEL).toBe('ds-badge__label');
  expect(domConstants.BADGE__VALUE).toBe('ds-badge__value');
  expect(domConstants.BADGE_WRAPPER).toBe('ds-badge__wrapper');
  expect(domConstants.BADGE_WRAPPER__SMALL).toBe('ds-badge__wrapper--small');
  expect(domConstants.BADGE_WRAPPER__ACTION_ITEM).toBe('ds-badge__wrapper--action-item');
  expect(domConstants.CITIZEN_EXPERIENCE).toBe('ds-citizen-experience-wrapper');
  expect(domConstants.CITIZEN_EXPERIENCE_MOBILE).toBe('ds-citizen-experience-wrapper--mobile');
  expect(domConstants.FOOTER_HORIZONTAL_DIVIDER).toBe('ds-footer__horizontal-divider');
  expect(domConstants.LOGO).toBe('ds-logo-wrapper');
  expect(domConstants.LOGO_OFFICIAL_CLOSE_BUTTON).toBe('ds-official-website-popup__close-button');
  expect(domConstants.LOGO_OFFICIAL_WRAPPER).toBe('ds-official-website-popup__wrapper');
  expect(domConstants.LOGO_SVG).toBe('logo-svg');
  expect(domConstants.LOGO_VERT_LINE).toBe('ds-logo-vert-line');
  expect(domConstants.MAIN_MENU).toBe('main-menu__wrapper');
  expect(domConstants.MAIN_MENU__HAMBURGER).toBe('main-menu__hamburger');
  expect(domConstants.MAIN_MENU__HAMBURGER_ID).toBe('ds-main-menu__hamburger');
  expect(domConstants.MAIN_MENU__HAMBURGER_ICON_ID).toBe('ds-main-menu__hamburger-icon');
  ...
  expect(domConstants.MOBILE__HIDDEN).toBe('ds-header-mobile--hidden');
  expect(domConstants.MOBILE__UTAH_ID).toBe('ds-header-mobile__id-wrapper');
  expect(domConstants.MOBILE__VIP_ACTION_ITEMS__LEFT).toBe('ds-header-mobile__vip-action-items--left');
  expect(domConstants.MOBILE__VIP_ACTION_ITEMS__RIGHT).toBe('ds-header-mobile__vip-action-items--right');
  expect(domConstants.ACTION_ITEM__SELECTED).toBe('ds-header-mobile-menu__action-item--selected');
  expect(domConstants.MOBILE_MENU).toBe('ds-header-mobile-menu');
  expect(domConstants.MOBILE_MENU__ACTION_BAR).toBe('ds-header-mobile-menu__action-bar');
  expect(domConstants.MOBILE_MENU__BACKDROP).toBe('ds-header-mobile-menu__backdrop');
  expect(domConstants.MOBILE_MENU__CONTENT).toBe('ds-header-mobile-menu__content');
  expect(domConstants.MOBILE_MENU__CONTENT_ITEM).toBe('ds-header-mobile-menu__content-item');
  expect(domConstants.MOBILE_MENU__WRAPPER).toBe('ds-header-mobile-menu__wrapper');
  expect(domConstants.MOBILE_MENU_ACTON_BAR__HOME_ID).toBe('ds-header-mobile-menu_action-bar__home');
  expect(domConstants.MOBILE_MENU_ACTON_BAR__PROFILE_ID).toBe('ds-header-mobile-menu_action-bar__profile');
  expect(domConstants.MOBILE_MENU_ACTION_BAR__ACTION_ITEM_WRAPPER).toBe('ds-header-mobile-menu__action-item');
  ...
  expect(domConstants.EXTERNAL_LINK).toBe('ds-icon-after-external-link');
  expect(domConstants.EXTERNAL_LINK__NEW_TAB).toBe('ds-new-tab-link-a11y');
  ...
  expect(domConstants.TITLE).toBe('ds-title-wrapper');
  expect(domConstants.TITLE__LOGO).toBe('ds-title-wrapper__logo');
  expect(domConstants.TITLE__TITLE).toBe('ds-title-wrapper__title');
  expect(domConstants.TOOLTIP).toBe('ds-tooltip');
  ...
  expect(domConstants.UTAH_ID).toBe('ds-id-wrapper');
  expect(domConstants.UTAH_ID__BUTTON).toBe('ds-id__button');
}
...
export function isMobileMainMenuOn() {
  ...
  return !!mainMenu && !mainMenu.classList.contains('ds-header-mobile--hidden');
}
...
export function isUtahIdInCitizenExperience() {
  return !!document.querySelector('.ds-id-wrapper .ds-id__button');
}
/**
 * @returns {boolean}
 */
export function isMobileUtahIdInInMainMenu() {
  return !!document.querySelector('.main-menu__wrapper .ds-header-mobile__id-wrapper .ds-id__button');
}
/**
 * @returns {boolean}
 */
export function isMobileUtahIdActionItemInMobileContent() {
  const mobileActionBarItems = document.querySelectorAll('.ds-header-mobile-menu__action-bar > div .icon-button');
...
export function isActionItemsInCitizenExperience() {
  return !!document.querySelector('.ds-action-items-wrapper .ds-header-action-item:first-child');
}
/**
 * @returns {boolean}
 */
...
export function isSearchInCitizenExperience() {
  return !!document.querySelector('.ds-citizen-experience-wrapper .main-menu__search');
}
/**
 * @returns {boolean}
 */
export function isMobileSearchInCitizenExperience() {
  const mobileSearchInCitizenExperience = document.querySelector('.ds-citizen-experience-wrapper--mobile .main-menu__search');
...
export function isMobileHamburgerInCitizenExperience() {
  return !!document.querySelector('.ds-citizen-experience-wrapper--mobile .main-menu__hamburger');
}
