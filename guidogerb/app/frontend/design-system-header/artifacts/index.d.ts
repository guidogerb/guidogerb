declare module "design-system-header" {
  ...
  export type Events = "HeaderLoaded" | "HeaderUnloaded";
  ...
  export function getHeaderSettings(): Settings;
  ...
  export function setHeaderSettings(newSettings: SettingsInput): Settings;
  export function setFooterSettings(footerSettings?: FooterSettings | undefined): FooterSettings | undefined;
