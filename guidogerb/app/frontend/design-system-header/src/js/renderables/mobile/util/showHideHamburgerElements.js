...
export function hideMobileMenu() {
  ...
  // change from an 'X'
  hamburgerIcon?.classList.add('ds-icon-before-hamburger');
  hamburgerIcon?.classList.remove('ds-icon-before-x-icon');
...
export function showMobileMenu() {
  ...
  // change to an 'X'
  hamburgerIcon?.classList.remove('ds-icon-before-hamburger');
  hamburgerIcon?.classList.add('ds-icon-before-x-icon');
