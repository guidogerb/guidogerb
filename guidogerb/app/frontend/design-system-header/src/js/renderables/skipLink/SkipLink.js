...
export function SkipLink() {
  ...
  if (skipLinkUrl) {
    ...
    console.warn('Design System: It is best practice to provide a skip link url (skipLinkUrl). See: https://designsystem/library/components/navigationLinks/skipLink');
  }
