...
/**
 * Events
 * @typedef {'HeaderLoaded' | 'HeaderUnloaded'} Events
 */
 ...
 *  @property {'left' | 'none' | 'right'} [mobileMenuLocation] - positioned right or left of the ID button? not at all? default is none
 ...
 * // To prevent this jankiness, your application should call setHeaderSettings with a userInfo.currentUser value of `null`. This way
