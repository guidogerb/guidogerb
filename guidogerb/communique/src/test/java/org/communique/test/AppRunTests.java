...
public class AppRunTests {
    ...
    public static void main(String[] args) {
        BigInteger first = new BigInteger("10001100001100",2);
        BigInteger two = new BigInteger("000110",2);
        BigInteger third = new BigInteger("1000110 1001110 1001100".replace(" ",""),2);
        byte[] input = {(byte) 0b10001100, (byte) 0b10001101, (byte) 0b10001101, (byte) 0b11001100, (byte) 0b10011100, (byte) 0b10001101};
        //byte[] input = {(byte) 0b11001100, (byte) 0b10011100, (byte) 0b10001101};
        List<BigInteger> result = digestIDs(input);
