...
The autogenerated repository table was removed because many upstream README snippets contain HTML, images, and unescaped markdown that break table layout and rendering. Until the generator is updated to sanitize or summarize descriptions safely, browse repositories directly here:

- [View all repositories in the `guidogerb` account](https://github.com/guidogerb?tab=repositories)
- [Browse submodules in this repo](https://github.com/guidogerb/guidogerb/tree/test/submodules)
